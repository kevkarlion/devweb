...
export function HeroSection() {
  return (
    <div className="w-full">
      <section
        className="relative min-h-screen flex flex-col items-center justify-center px-6 w-full  pt-32 pb-16"
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center flex flex-col items-center w-full">
          ...
          <motion.h1
            className="font-[family-name:var(--font-inter-bold)] text-[clamp(3rem,12vw,8rem)] leading-[0.9] text-[#121212] pb-8 text-balance max-w-full overflow-hidden"
          ...
          <motion.p
            className="font-[family-name:var(--font-inter-semibold)] text-[clamp(1.25rem,3vw,2rem)] text-[#121212]/70 max-w-3xl mx-auto pt-2"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
