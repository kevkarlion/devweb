  ...
  return (
    <div className={`${jetbrainsMono.variable}`}>
      <section
        ...
        className="relative flex items-center justify-center w-full min-h-screen overflow-hidden pt-14 pb-20 bg-black lg:pt-24"
      >
        <div className="relative z-10 max-w-8xl mx-auto w-full bg-black">
          ...
          <div className="lg:hidden flex flex-col items-center text-center">
            ...
            <div className="relative w-full mb-4">
              <motion.div className="relative w-full h-64 mx-auto -mt-10 flex justify-center items-center">
                <Image
                  src="/imghero.png"
                  alt="Gestión digital profesional en Patagonia"
                  width={800}
                  height={600}
                  className="object-contain w-full translate-x-[30%] pb-16"
                  priority
                />
          ...
          <div className="hidden lg:grid lg:mt-16 grid-cols-1 lg:grid-cols-[55%_45%] items-start min-h-[75vh] px-8 bg-black">
            ...
            <motion.div className="relative h-125 xl:h-150 z-20">
              <Image
                src="/imghero.png"
                alt="Presencia digital estratégica"
                fill
                className="object-contain object-right pb-10"
                priority
              />
            </motion.div>
          </div>
